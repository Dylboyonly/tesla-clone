...
const TapBackground: React.FC = () => {
  ...
  return (
    <div
      ...
      //   onScroll={handleTap}
      //   on
      className="h-screen w-full transition-all duration-500 relative"
      style={{
    ...
    >
      <div className="w-full h-[15%]">
        <header className="navbar w-full mt-0 ml-0 px-2 py-3 flex justify-between items-center bg-white backdrop-blur-md bg-opacity-10 h-[70px]">
          <Link
            href="/"
